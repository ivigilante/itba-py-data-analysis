...
# Dividir el area cubierta por el censo en cuadrantes de 0.5 de latitud x 0.5 de longitud, 
# encontrar para qué cuadrante el valor medio de 'median_house_value' es máximo. 
# Asignar el paso como una variable para que pueda cambiarse facilmente. 
# Para filtrar las zonas de muy baja residencia descarten los valores cuando hay menos de 100 casas
...
# Tips: El programa va a tardar en correr, no se asusten! Pueden investigar funciones de numpy para ayudarlos a resolver el problema numpy.arange.
